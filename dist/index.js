...
export default function DaliryReactRadialChart({ value = 0, maxValue, label = "success", okColor = "#79D56C", dangerColor = "#FF6077", trackColor = "#2B3038", cardBg = "#1C2027", width = 220, height = 180, animationDuration = 700, scale = 1, textColor = "#D8DCE3", }) {
    ...
    return (_jsxs("div", { style: {
        ...
        }, children: [_jsxs("svg", { width: svgWidth, height: svgHeight, viewBox: `0 0 ${svgWidth} ${svgHeight}`, fill: "none", children: [safeMaxValue !== null && (_jsxs(_Fragment, { children: [_jsx("path", { d: describeArc(cx, cy, outerRadius, startAngle, endAngle), stroke: trackColor, strokeWidth: outerStrokeWidth, strokeLinecap: "butt", opacity: "0.35" }), outerOkPath && (_jsx("path", { d: outerOkPath, stroke: okColor, strokeWidth: outerStrokeWidth, strokeLinecap: "butt" })), outerDangerPath && (_jsx("path", { d: outerDangerPath, stroke: dangerColor, strokeWidth: outerStrokeWidth, strokeLinecap: "butt" }))] })), _jsx("path", { d: innerTrackPath, stroke: trackColor, strokeWidth: innerStrokeWidth, strokeLinecap: "butt" }), valuePath && (_jsx("path", { d: valuePath, stroke: valueColor, strokeWidth: innerStrokeWidth, strokeLinecap: "butt" })), _jsx("text", { x: cx, y: 95 * scale, textAnchor: "middle", fill: valueColor, fontWeight: "400", fontFamily: "inherit", style: {
                            fontSize: 18 * scale,
